...
const AboutPage = () => {
    return (
        <main className="flex min-h-screen flex-col items-center justify-between pt-16">
            ...
            <section className='w-[90%] mx-auto h-auto py-16'>
                <div className='flex flex-wrap md:flex-nowrap items-center'>
                    ...
                    <div className='relative w-full h-full'>
                        <Image src='/daniel.webp' width={0} height={0} alt='' className='object-contain hidden md:block w-full opacity-80 hover:opacity-100 transition-all duration-300 rounded-[24px]' sizes='100vw' quality={100}/>
                    </div>
                </div>
            </section>
            <section className='h-auto'>
                <div className='w-[80%] mx-auto'>
                    ...
                    <p className='pl-48 py-2 text-[18px] '>קורס המקיף והאיכותי ביותר לעריכת וידאו בכדורגל בתוכנת Adobe Premiere. נצלו את הזמן כבר עכשיו כדי ללמוד עריכת וידאו בכודרגל אצלנו שלב אחר שלב , ללא שום צורך בניסיון קודם בעריכת וידאו.</p>
                </div>
